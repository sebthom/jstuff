...
public class BoundedThreadPoolExecutor extends ThreadPoolExecutor
{
	...
	private static final RejectedExecutionHandler FORCE_QUEUE_POLICY = new RejectedExecutionHandler()
		{
			...
			{
				if (executor.isShutdown()) throw new RejectedExecutionException(executor + " has been shutdown.");
	...
	/**
	 * Creates a new <tt>ScalingThreadPoolExecutor</tt> with the given
	 ...
	 * @throws IllegalArgumentException if minPoolSize, or keepAliveTime less than zero, or if maxPoolSize less than or equal to zero, or if minPoolSize greater than maxPoolSize.
	 */
	public BoundedThreadPoolExecutor(final int minPoolSize, final int maxPoolSize, final long keepAliveTime, final TimeUnit unit)
	{
