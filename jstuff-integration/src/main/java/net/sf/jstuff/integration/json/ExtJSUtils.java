...
public abstract class ExtJSUtils {
    ...
    public static String getRecordFieldType(final Class<?> fieldType) {
        ...
        if (Integer.class.isAssignableFrom(fieldType) || Long.class.isAssignableFrom(fieldType) || Short.class.isAssignableFrom(fieldType) || int.class
            .isAssignableFrom(fieldType) || long.class.isAssignableFrom(fieldType) || short.class.isAssignableFrom(fieldType) || BigInteger.class
                .isAssignableFrom(fieldType) || Byte.class.isAssignableFrom(fieldType) || byte.class.isAssignableFrom(fieldType))
            return "int";
