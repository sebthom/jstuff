...
public abstract class SQLUtils
{
	 ...
	 * @throws SQLException
	 */
	public static PreparedStatement buildInsertStatement(final Connection con, final String table, final Map<String, Object> columns)
			throws SQLException
	{
		Args.notEmpty("table", table);
	 ...
	 * @throws SQLException
	 */
	public static PreparedStatement buildUpdateStatement(final Connection con, final String table, final Map<String, Object> columns,
