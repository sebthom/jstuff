...
public class AtomBlogUtils
{
			...
			throws DeletingAtomBlogEntryFailedException
	{
		...
		{
			if (ex instanceof DeletingAtomBlogEntryFailedException) throw (DeletingAtomBlogEntryFailedException) ex;
			...
			throws ReceivingAtomBlogsFailedException
	{
		...
		{
			if (ex instanceof ReceivingAtomBlogsFailedException) throw (ReceivingAtomBlogsFailedException) ex;
			...
			final String logonName, final String password) throws PublishingAtomBlogEntryFailedException
	{
		try
		{
			...
			staxWriter.writeStartDocument();
			{
				...
				{
					if (atomBlogEntry.getTags() != null) for (final String category : atomBlogEntry.getTags())
					{
